...
The files in this folder covers such tiles for Australia on what is 
referred to as level 1. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_01_aus.dbf   Attribute file
qdgc_01_aus.prj   Projection file
qdgc_01_aus.shp   Spatial data file (shapefile)
qdgc_01_aus.shx   Index file
