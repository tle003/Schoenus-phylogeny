...
The files in this folder covers such tiles for South Africa on what is 
referred to as level 3. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_03_zaf.dbf   Attribute file
qdgc_03_zaf.prj   Projection file
qdgc_03_zaf.shp   Spatial data file (shapefile)
qdgc_03_zaf.shx   Index file
