...
The files in this folder covers such tiles for New Zealand on what is 
referred to as level 2. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_02_nzl.dbf   Attribute file
qdgc_02_nzl.prj   Projection file
qdgc_02_nzl.shp   Spatial data file (shapefile)
qdgc_02_nzl.shx   Index file
