...
results_DEC <- readRDS("results_DEC_constrained-constrained05-Jan2021.rds")
tr <- read.tree("Schoeneae_tree_ultrametric-Jan2021.tre")
tipranges <- getranges_from_LagrangePHYLIP("Schoeneae-DEC-9areas.txt")
...
pdf("Schoeneae-constrained_phytools-Jan2021.pdf", width = 10, height = 15)
plotTree(
...
pdf("Schoeneae-constrained-Jan2021.pdf", width = 10, height = 15)
