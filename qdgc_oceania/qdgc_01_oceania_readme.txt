...
The files in this folder covers such tiles for Oceania on what is 
referred to as level 1. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_01_oceania.dbf   Attribute file
qdgc_01_oceania.prj   Projection file
qdgc_01_oceania.shp   Spatial data file (shapefile)
qdgc_01_oceania.shx   Index file
